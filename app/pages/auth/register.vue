...
const validateForm = () => {
  ...
  if (!confirmPassword.value) {
    errors.value.push("Please confirm your password.");
...
const handleRegister = async () => {
  ...
  try {
    ...
    const existingUsers = await $fetch<any[]>(`${API_URL}/users`, {
      params: {
  ...
  >
    ...
    >
      ...
      <div class="mb-8 text-center">
        ...
        <p class="mt-2 text-sm text-gray-500">Create your ReadPlus account</p>
      </div>
      ...
      <form @submit.prevent="handleRegister" class="space-y-5">
        ...
        <div class="rounded-xl border border-[#dce9e4] bg-[#f2f9f7] p-4">

...
const handleAddToCart = () => {
  ...
  // Add the book according to the quantity selected
  ...
  <div class="min-h-screen bg-[#fafafa] text-gray-900">
    ...
    >
      ...
      <div class="grid animate-pulse grid-cols-1 gap-12 lg:grid-cols-2">
        ...
        <div
          class="h-130 rounded-3xl bg-gray-200"
        ></div>
        ...
        <div class="flex flex-col justify-center">
          ...
          <div
            class="mt-5 h-12 w-3/4 rounded bg-gray-200"
          ></div>

          <div
            class="mt-4 h-5 w-1/3 rounded bg-gray-200"
          ></div>

          <div
            class="mt-8 h-5 w-full rounded bg-gray-200"
          ></div>

          <div
            class="mt-3 h-5 w-5/6 rounded bg-gray-200"
          ></div>

          <div
            class="mt-10 h-12 w-full rounded bg-gray-200"
          ></div>
    ...
    >
      ...
      <div class="max-w-md text-center">
        ...
        <h1
          class="mt-5 font-serif text-3xl font-bold text-gray-950"
        >
          Book not found
        </h1>
    ...
    >
      ...
      >
        ...
        <div>
          ...
          >
            ...
            <div
              class="flex h-110 items-center justify-center p-10 sm:h-130"
            >
          ...
          >
            ...
            >
              ...
              <p
                class="mt-1 text-xs font-semibold text-gray-900"
              >
                {{ book.format || 'N/A' }}
              </p>
        ...
        >
          ...
          <div>
            ...
            >
              ...
              <span
                class="text-3xl font-bold tracking-tight text-gray-950"
              >
          ...
          >
            ...
            <p
              class="mt-3 text-center text-[10px] text-gray-400 sm:text-left"
            >
              Quantity:
          ...
          <div
            class="mt-10 rounded-2xl border border-gray-200 bg-white p-5"
          >
      ...
      >
        ...
        >
          ...
          <h2
            class="mt-2 font-serif text-3xl font-bold text-gray-950"
          >
            {{ book.shortTitle || book.title }}
          </h2>
        ...
        >
          ...
          >
            ...
            >
              ...
              <NuxtLink
                :to="`/productDetail/${related.id}`"
              >

                <div
                  class="flex h-80 items-center justify-center p-7"
                >
      ...
      <div
        class="mt-20 flex justify-center border-t border-gray-200 pt-8"
      >
